...
import { h, view, pads, Bitmap } from "./lib";
...
import { IO } from "./io";
import { VirtioConsole } from "./virtio_console";
import { PCI } from "./pci";
import { PS2 } from "./ps2";
import { read_elf } from "./elf";

import { FloppyController } from "./floppy";
import { IDEDevice } from "./ide";
import { VirtioNet } from "./virtio_net";
import { VGAScreen } from "./vga";
import { VirtioBalloon } from "./virtio_balloon";
import { Virtio9p } from "../lib/9p";
...
export class CPU {
    private stop_idling: any;
    private wm: any;
    private wasm_memory: any;
    private memory_size: any;
    private mem8: Uint8Array<ArrayBuffer>;
    private mem32s: Int32Array<any>;
    private segment_is_null: any;
    private segment_offsets: any;
    private segment_limits: any;
    private segment_access_bytes: any;
    private protected_mode: any;
    private idtr_size: any;
    private idtr_offset: any;
    private gdtr_size: any;
    private gdtr_offset: any;
    private tss_size_32: any;
    private page_fault: any;
    private cr: any;
    private cpl: any;
    private is_32: any;
    private stack_size_32: any;
    private in_hlt: any;
    private last_virt_eip: any;
    private eip_phys: any;
    private sysenter_cs: any;
    private sysenter_esp: any;
    private sysenter_eip: any;
    private prefixes: any;
    private flags: any;
    private flags_changed: any;
    private last_op_size: any;
    private last_op1: any;
    private last_result: any;
    private current_tsc: any;
    private devices: {};
    private instruction_pointer: any;
    private previous_ip: any;
    private apic_enabled: any;
    private acpi_enabled: any;
    private memory_map_read8: never[];
    private memory_map_write8: never[];
    private memory_map_read32: never[];
    private memory_map_write32: never[];
    private bios: { main: null; vga: null; };
    private instruction_counter: any;
    private reg32: any;
    private fpu_st: any;
    private fpu_stack_empty: any;
    private fpu_stack_ptr: any;
    private fpu_control_word: any;
    private fpu_status_word: any;
    private fpu_ip: any;
    private fpu_ip_selector: any;
    private fpu_opcode: any;
    private fpu_dp: any;
    private fpu_dp_selector: any;
    private reg_xmm32s: any;
    private mxcsr: any;
    private sreg: any;
    private dreg: any;
    private reg_pdpte: any;
    private svga_dirty_bitmap_min_offset: any;
    private svga_dirty_bitmap_max_offset: any;
    private fw_value: never[];
    private fw_pointer: number;
    private option_roms: never[];
    private io: undefined;
    private bus: any;
    private seen_code: any;
    private seen_code_uncompiled: any;

    constructor(bus: any, wm: any, stop_idling: any) {
    ...
    mmap_read16(addr: number) {
        var fn: Function = this.memory_map_read8[addr >>> MMAP_BLOCK_BITS];
        const value = fn(addr) | fn(addr + 1 | 0) << 8;
        dbg_assert(value >= 0 && value <= 0xFFFF);
        return value;
    }
    mmap_write16(addr: number, value: number) {
        var fn: Function = this.memory_map_write8[addr >>> MMAP_BLOCK_BITS];
    ...
    mmap_write64(addr: number, value0: any, value1: any) {
        var aligned_addr = addr >>> MMAP_BLOCK_BITS;
        // This should hold since writes across pages are split up
        dbg_assert(aligned_addr === (addr + 7) >>> MMAP_BLOCK_BITS);

        var write_func32: Function = this.memory_map_write32[aligned_addr];
        write_func32(addr, value0);
        write_func32(addr + 4, value1);
    }
    mmap_write128(addr: number, value0: any, value1: any, value2: any, value3: any) {
        var aligned_addr = addr >>> MMAP_BLOCK_BITS;
        // This should hold since writes across pages are split up
    ...
    write_blob(blob: any, offset: number | undefined) {
    ...
    read_blob(offset: number | undefined, length: any) {
        if (length) {
            dbg_assert(!this.in_mapped_range(offset));
    ...
    unpack_memory(bitmap: any, packed_memory: any) {
    ...
    create_memory(size: any, minimum_size: number) {
    ...
    load_multiboot_option_rom(buffer: any, initrd: any, cmdline: any) {
    ...
    fill_cmos(rtc: any, settings: any) {
    ...
    codegen_finalize(wasm_table_index: number, start: number, state_flags: any, ptr: any, len: any) {
        ptr >>>= 0;
        len >>>= 0;
    ...
    log_uncompiled_code(start: number, end: number) {
    ...
    dump_function_code(block_ptr: number, count: number) {
    ...
    run_hardware_timers(acpi_enabled: any, now: any) {
