...
import { DELIVERY_MODES, DESTINATION_MODES, APIC_LOG_VERBOSE } from "./apic";
...
export class IOAPIC {
    cpu: CPU;
    ioredtbl_config: Int32Array<ArrayBuffer>;
    ioredtbl_destination: Int32Array<ArrayBuffer>;
    ioregsel: number;
    ioapic_id: number;
    irr: number;
    irq_value: number;
