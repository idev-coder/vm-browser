...
export class PIT {
    cpu: CPU;
    bus: any;
    counter_start_time: Float64Array<ArrayBuffer> | any;
    counter_start_value: Uint16Array<ArrayBuffer> | any;
    counter_next_low: Uint8Array<ArrayBuffer> | any;
    counter_enabled: Uint8Array<ArrayBuffer> | any;
    counter_mode: Uint8Array<ArrayBuffer> | any;
    counter_read_mode: Uint8Array<ArrayBuffer> | any;
    counter_latch: Uint8Array<ArrayBuffer> | any;
    counter_latch_value: Uint16Array<ArrayBuffer> | any;
    counter_reload: Uint16Array<ArrayBuffer> | any;
    constructor(cpu: CPU, bus: any) {
        /** @const @type {CPU} */
        this.cpu = cpu;
        ...
        cpu.io.register_write(0x61, this, (data: number) => {
            if (data & 1) {
        ...
        cpu.io.register_read(0x40, this, () => { return this.counter_read(0); });
        cpu.io.register_read(0x41, this, () => { return this.counter_read(1); });
        cpu.io.register_read(0x42, this, () => { return this.counter_read(2); });

        cpu.io.register_write(0x40, this, (data: any) => { this.counter_write(0, data); });
        cpu.io.register_write(0x41, this, (data: any) => { this.counter_write(1, data); });
        cpu.io.register_write(0x42, this, (data: any) => {
    ...
    set_state(state: Uint16Array<ArrayBuffer>[]) {
    ...
    get_counter_value(i: string | number, now: number) {
    ...
    did_rollover(i: string | number, now: number) {
        var diff = now - this.counter_start_time[i];
    ...
    counter_write(i: string | number, value: number) {
