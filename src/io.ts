import { LOG_IO, MMAP_BLOCK_BITS, MMAP_BLOCK_SIZE, MMAP_MAX } from "./const";
import { h } from "./lib";
...
export class IO {
    ...
    constructor(cpu: CPU) {
        ...
        this.mmap_register(memory_size, MMAP_MAX - memory_size,
            ...
            function (addr: number, value: any) {
            ...
            function (addr: number, value: number) {
     ...
     */
    register_read(port_addr:number, device:any, r8?:Function, r16?:Function, r32?:Function) {
     ...
     */
    register_write(port_addr:number, device:any, w8?:Function, w16?:Function, w32?:Function) {
        dbg_assert(typeof port_addr === "number");
        dbg_assert(typeof device === "object");
     ...
     */
    register_read_consecutive(port_addr:number, device:any, r8_1:Function, r8_2:Function, r8_3:Function, r8_4:Function) {
     ...
     */
    register_write_consecutive(port_addr:number, device:any, w8_1:Function, w8_2:Function, w8_3:Function, w8_4:Function) {
        dbg_assert(arguments.length === 4 || arguments.length === 6);
     ...
     * @param {*=} write_func32
     */
    mmap_register(addr, size, read_func8, write_func8, read_func32, write_func32) {
